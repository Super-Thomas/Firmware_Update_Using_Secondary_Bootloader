...
#define ECAP_CAP_INPUT_SRC_FROM_CPO           (1UL)    /*!< CAP input source from CPO            */
#define ECAP_CAP_INPUT_SRC_FROM_OPDO_ADCMPO   (3UL)    /*!< CAP input source from OPDO or ADCMPO */
...
/**
  ...
  */
#define ECAP_SET_NOISE_FILTER_CLKDIV(ecap, u32ClkSel) ((ecap)->CTL0 = ((ecap)->CTL0 & ~ECAP_CTL0_NFDIS_Msk)|((u32ClkSel)<<ECAP_CTL0_NFDIS_Pos))
...
/**
  ...
  */
#define ECAP_NOISE_FILTER_DISABLE(ecap) ((ecap)->CTL0 |= ECAP_CTL0_CAPNF_DIS_Msk)
...
/**
  ...
  */
#define ECAP_NOISE_FILTER_ENABLE(ecap, u32ClkSel) ((ecap)->CTL0 = ((ecap)->CTL0 & ~(ECAP_CTL0_CAPNF_DIS_Msk|ECAP_CTL0_NFDIS_Msk))|(u32ClkSel));

/**
  * @brief This macro is used to enable input channel unit
  * @param[in] ecap      Specify ECAP port
  * @param[in] u32Mask   The input channel mask
  *                  - \ref ECAP_CTL0_CAPEN0_Msk
  *                  - \ref ECAP_CTL0_CAPEN1_Msk
  *                  - \ref ECAP_CTL0_CAPEN2_Msk
  * @return None
...
/**
  ...
  *                  - \ref ECAP_CAP_INPUT_SRC_FROM_CPO
  *                  - \ref ECAP_CAP_INPUT_SRC_FROM_CH
  *                  - \ref ECAP_CAP_INPUT_SRC_FROM_OPDO_ADCMPO
  * @return None
...
/**
  ...
  */
#define ECAP_SEL_TIMER_CLK_SRC(ecap, u32ClkSrc) ((ecap)->CTL1 = ((ecap)->CTL1 & ~ECAP_CTL1_SRCSEL_Msk)|((u32ClkSrc)<<ECAP_CTL1_SRCSEL_Pos))
...
/**
  ...
  * @param[in] ecap      Specify ECAP port
  * @param[in] u32Mask  The input channel mask
  *                  - \ref ECAP_STATUS_CAPF0_Msk
  *                  - \ref ECAP_STATUS_CAPF1_Msk
  *                  - \ref ECAP_STATUS_CAPF2_Msk
  * @return None
...
/**
  ...
  */
#define ECAP_CLR_CMP_MATCH_FLAG(ecap) ((ecap)->STATUS = ECAP_STATUS_CMPF_Msk)
...
/**
  ...
  */
#define ECAP_CLR_OVF_FLAG(ecap) ((ecap)->STATUS = ECAP_STATUS_OVF_Msk)
...
/**
  ...
  */
#define ECAP_GET_CNT_HOLD_VALUE(ecap, u32Index) (*(__IO uint32_t *) (&((ecap)->HOLD0) + (u32Index)))
