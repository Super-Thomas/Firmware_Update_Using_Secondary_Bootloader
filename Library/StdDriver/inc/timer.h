 ...
 * $Revision: 4 $
 * $Date: 15/04/01 7:31p $
 * @brief    M0519 series Timer driver header file
 *
 * @note
...
/** @addtogroup M0519_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup M0519_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group M0519_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup M0519_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group M0519_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0519_TIMER_Driver */
