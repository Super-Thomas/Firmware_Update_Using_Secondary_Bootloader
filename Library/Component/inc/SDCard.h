...
/** @addtogroup SDCARD_EXPORTED_CONSTANTS SDCard Library Exported Constants
  @{
*/
...
#define BACK_FROM_ERROR { SingleWrite(0xFF); SPI_SET_SS_HIGH(g_pSPI);  return FALSE;} /*!< macro for SPI write */
...
/*@}*/ /* end of group SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup SDCARD_EXPORTED_STRUCTS SDCard Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group SDCARD_EXPORTED_STRUCTS */
