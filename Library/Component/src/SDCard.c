 ...
 * $Revision: 2 $
 * $Date: 15/04/01 7:35p $
 * @brief    NM1530 SD Card source file
 *
 * @note
...
/** @addtogroup SDCARD SDCard Library
  @{
*/
...
/** @addtogroup SDCARD_EXPORTED_FUNCTIONS SDCard Library Exported Functions
  @{
*/
...
//          SD_Delay(1);
            ...
            //  SPI_WRITE_TX(g_pSPI/*SPI1*/, 0xFFFFFFFF);//SPI_WRITE_TX0(g_pSPI/*SPI1*/, 0xFFFFFFFF);
            // while(SPI_IS_BUSY(g_pSPI/*SPI1*/));
...
{
    /* Configure SPI interface: master mode, 8-bit transaction */
    SPI_Open(g_pSPI, SPI_MASTER, SPI_MODE_0, 8, 300000);
    ...
    Gfreq = SPI_SetBusClock(g_pSPI, 10000000);
...
/*@}*/ /* end of group SDCARD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group SDCard_Driver */
